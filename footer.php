...
?>
	...
	<footer id="colophon" role="contentinfo">
		<div id="site-generator" class="wrapper">
			<p><?php printf( __( 'Powered by: %1$s.', 'ggswp' ), '<a href="http://wordpress.org/" rel="generator">WordPress</a>' ); ?> <span class="sep"> | </span><?php printf( __( 'Theme: %1$s by %2$s.', 'ggswp' ), '<a href="http://fthrwght.com/ggswp" rel="developer">Golden Grid System WP</a>', '<a href="http://fthrwght.com/" rel="developer">Allan Cole</a>' ); ?> <span class="sep"> | </span><?php printf( __( 'Original Concept: %1$s by %2$s.', 'ggswp' ), '<a href="http://goldengridsystem.com/" rel="concept">Golden Grid System</a>', '<a href="http://jonikorpi.com/" rel="designer">Joni Korpi</a>' ); ?></p>
		</div>
